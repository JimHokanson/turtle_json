    ...
    methods
        function obj = parsing_info(parent_obj, result)
            ...
            obj.object_ai = h__createAISummaryString(ai.n_objects_allocated,...
                length(result.child_count_object),ai.n_object_allocations);
            obj.array_ai = h__createAISummaryString(ai.n_arrays_allocated,...
                length(result.child_count_array),ai.n_array_allocations);
            obj.key_ai = h__createAISummaryString(ai.n_keys_allocated,...
                length(result.key_p),ai.n_key_allocations);
