...
temp([45 49:58]) = {'&&S_PARSE_NUMBER_IN_ARRAY'};
temp{'n'} = '&&S_PARSE_NULL_IN_ARRAY';
temp{'t'} = '&&S_PARSE_TRUE_IN_ARRAY';
temp{'f'} = '&&S_PARSE_FALSE_IN_ARRAY';
temp{'"'} = '&&S_PARSE_STRING_IN_ARRAY';
temp{'{'} = '&&S_OPEN_OBJECT_IN_ARRAY;';
temp{'['} = '&&S_OPEN_ARRAY_IN_ARRAY';
